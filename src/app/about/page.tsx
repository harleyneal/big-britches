    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-[var(--color-snow-dark)]">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <p className="text-[var(--color-snow-accent2)] font-semibold text-sm uppercase tracking-wider mb-3">Our Story</p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold text-[var(--color-snow-dark)] mb-6">Why We Exist</h2>
              <p className="text-[var(--color-snow-muted)] leading-relaxed mb-4">
              ...
              <p className="text-[var(--color-snow-muted)] leading-relaxed">
            ...
            <div className="bg-[var(--color-snow-light)] rounded-2xl p-10 text-center">
              <div className="text-6xl font-black text-[var(--color-snow-accent)]/20 mb-2">SL</div>
              <p className="text-[var(--color-snow-dark)] font-bold text-lg">Snow Leopard Labs LLC</p>
              <p className="text-[var(--color-snow-muted)] text-sm mt-1">Web Design & Development</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-[var(--color-snow-light)]">
        <div className="max-w-5xl mx-auto px-6">
          <h2 className="text-3xl font-bold text-[var(--color-snow-dark)] text-center mb-12">What We Stand For</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {values.map((v) => (
              <div key={v.title} className="bg-white p-8 rounded-2xl border border-gray-100">
                <h3 className="text-xl font-bold text-[var(--color-snow-dark)] mb-3">{v.title}</h3>
                <p className="text-[var(--color-snow-muted)] leading-relaxed">{v.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 bg-[var(--color-snow-dark)]">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="text-white/60 text-lg mb-10">We&apos;d love to hear about your business and how we can help you grow online.</p>
          <Link href="/contact" className="inline-block px-8 py-4 bg-[var(--color-snow-accent)] text-white rounded-xl font-semibold text-lg hover:bg-[var(--color-snow-accent)]/80 transition-all hover:scale-105 shadow-lg shadow-[var(--color-snow-accent)]/25">
            Get In Touch
          </Link>
        </div>
      </section>
