    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-[var(--color-snow-dark)]">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <p className="text-[var(--color-snow-accent2)] font-semibold text-sm uppercase tracking-wider mb-3">Simple, Transparent Pricing</p>
      ...
      <section className="py-20 bg-[var(--color-snow-light)]">
        <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-2xl p-10 shadow-sm border border-gray-100 flex flex-col">
            <p className="text-[var(--color-snow-accent)] font-semibold text-sm uppercase tracking-wider mb-2">Starter</p>
            <h3 className="text-2xl font-bold text-[var(--color-snow-dark)] mb-1">For Individuals & Small Businesses</h3>
            <div className="mt-6 mb-2">
              <span className="text-4xl font-black text-[var(--color-snow-dark)]">$29</span>
              <span className="text-[var(--color-snow-muted)]">/month</span>
            </div>
            <p className="text-sm text-[var(--color-snow-muted)] mb-8">$299 – $499 one-time deposit</p>
            <ul className="space-y-3 mb-10 flex-1">
              {starterFeatures.map((f) => (
                <li key={f} className="flex items-start gap-3 text-sm text-[var(--color-snow-text)]">
                  <svg className="w-5 h-5 text-[var(--color-snow-accent2)] shrink-0 mt-0.5" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
            ...
            <Link href="/contact" className="block text-center px-6 py-3 border-2 border-[var(--color-snow-accent)] text-[var(--color-snow-accent)] rounded-xl font-semibold hover:bg-[var(--color-snow-accent)] hover:text-white transition-all">
              Get Started
            </Link>
          </div>

          {/* Business */}
          <div className="bg-[var(--color-snow-dark)] rounded-2xl p-10 shadow-xl border border-white/10 flex flex-col relative overflow-hidden">
            <div className="absolute top-0 right-0 bg-[var(--color-snow-accent2)] text-[var(--color-snow-dark)] text-xs font-bold px-4 py-1.5 rounded-bl-xl">Most Popular</div>
            <p className="text-[var(--color-snow-accent2)] font-semibold text-sm uppercase tracking-wider mb-2">Business</p>
            ...
            <p className="text-sm text-white/40 mb-8">$599 – $999 one-time deposit</p>
            <ul className="space-y-3 mb-10 flex-1">
            ...
            <Link href="/contact" className="block text-center px-6 py-3 bg-[var(--color-snow-accent2)] text-[var(--color-snow-dark)] rounded-xl font-bold hover:bg-[var(--color-snow-accent2)]/80 transition-all">
              Get Started
            </Link>
          </div>
        </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-3xl mx-auto px-6">
          <h2 className="text-3xl font-bold text-[var(--color-snow-dark)] text-center mb-12">Frequently Asked Questions</h2>
          <div className="space-y-6">
            {faqs.map((faq) => (
              <div key={faq.q} className="border-b border-gray-100 pb-6">
                <h3 className="text-lg font-semibold text-[var(--color-snow-dark)] mb-2">{faq.q}</h3>
                <p className="text-[var(--color-snow-muted)] leading-relaxed">{faq.a}</p>
              </div>
            ))}
          </div>
        </div>
