...
export default function Footer() {
  return (
    <footer className="bg-[var(--color-snow-dark)] text-white/60 border-t border-white/10">
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          {/* Brand */}
          <div className="md:col-span-1">
            <Link href="/" className="flex items-center gap-3 mb-4">
              <Image src="/symbol.svg" alt="Snow Leopard Labs" width={28} height={28} />
              <span className="text-white font-bold text-lg">Snow Leopard Labs</span>
            </Link>
          ...
          <div>
            ...
            <div className="space-y-2">
              {[["About", "/about"], ["Services", "/services"], ["Pricing", "/pricing"], ["Contact", "/contact"]].map(([label, href]) => (
                <Link key={href} href={href} className="block text-sm hover:text-[var(--color-snow-accent2)] transition-colors">{label}</Link>
              ))}
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2 text-sm">
              ...
              <Link href="/contact" className="inline-block mt-3 px-5 py-2 bg-[var(--color-snow-accent)] text-white rounded-lg text-sm font-semibold hover:bg-[var(--color-snow-accent)]/80 transition-colors">
                Contact Us
              </Link>
            </div>
          </div>
