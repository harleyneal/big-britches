...
export async function sendApprovalEmail(
  ...
  const htmlBody = `
    ...
    <hr>
    <p>This content was generated by Snow Leopard's AI content system.</p>
  `;
...
export async function sendPublishedEmail(
  ...
  const htmlBody = `
    ...
    <hr>
    <p>This content was published by Snow Leopard's content distribution system.</p>
  `;
...
export async function sendRejectionEmail(
  ...
  const htmlBody = `
    ...
    <hr>
    <p>This notification was sent by Snow Leopard's content system.</p>
  `;
